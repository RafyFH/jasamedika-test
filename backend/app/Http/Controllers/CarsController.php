...
class CarsController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        // Return results
        return ApiFormatter::createApi(200, 'Sukses mendapatkan data', $cars);
    }
    public function carsAvail() {
        // Hanya mengambil mobil yang stoknya lebih dari 0
        $data = Cars::where('available', '=', 'true')->get();

        if ($data) {
            return ApiFormatter::createApi(200, 'Sukses mendapatkan data', $data);
        } else {
            return ApiFormatter::createApi(400, 'Gagal mendapatkan data');
        }
    }
